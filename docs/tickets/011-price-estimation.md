...
- [ ] `PriceEstimationJob` (Solid Queue, `default` queue):
...
- `app/jobs/price_estimation_job.rb` — async pricing job (queue_as :default)
- `app/jobs/route_calculation_job.rb` — modify to chain `PriceEstimationJob`
